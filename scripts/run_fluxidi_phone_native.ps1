...
if ($state -ne 'device') {
    throw "GSM $device is niet beschikbaar als device. Status: '$state'"
}

Write-Host "phone=$device state=device"
...
Write-Host ''
Write-Host 'GSM wordt nu gebouwd, geïnstalleerd en gestart...'
Write-Host ''
