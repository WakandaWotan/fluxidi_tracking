...
class _BusinessFirstRunWizardPageState
  ...
  static const List<_BusinessFirstRunStep> _steps = <_BusinessFirstRunStep>[
    ...
    _BusinessFirstRunStep(
      ...
      subtitle: _Tr(
        nl: 'Optioneel: vaste prijzen voor luchthavens of dorpen en steden. Sla over als niet relevant.',
        en: 'Optional: fixed prices for airports or villages and cities. Skip if not relevant.',
        fr: 'Optionnel : prix fixes pour aéroports ou villages et villes. Ignorez si non pertinent.',
        es: 'Opcional: precios fijos para aeropuertos o pueblos y ciudades. Omite si no aplica.',
      ),
    ),
    _BusinessFirstRunStep(
