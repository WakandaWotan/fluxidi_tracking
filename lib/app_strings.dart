...
const AppStrings _nl = AppStrings(
  ...
  calculatorExtraServiceOptionalLabel: LocalizedText(
    ...
    fr: 'Service supplémentaire (optionnel)',
  ...
  breakdownBaseDriveEx: LocalizedText(
    nl: 'Afstandskosten',
    en: 'Distance cost',
    fr: 'Frais de distance',
    es: 'Coste por distancia',
  ),
  breakdownExtraStopsEx: LocalizedText(
    nl: 'Extra stops',
    en: 'Extra stops',
    fr: 'Arrêts supplémentaires',
    es: 'Paradas adicionales',
  ),
  ...
  breakdownVatAmount: LocalizedText(nl: 'Btw', en: 'VAT', fr: 'TVA', es: 'IVA'),
