...
const AppStrings _nl = AppStrings(
  ...
  bookingSuccessPaymentRequiredMessage: LocalizedText(
    nl: 'Boeking aangemaakt. Betaling is vereist voordat de rit bevestigd wordt.',
    en: 'Booking created. Payment is required before the ride is confirmed.',
    fr: 'Reservation creee. Le paiement est requis avant confirmation de la course.',
    es: 'Reserva creada. Se requiere pago antes de confirmar el viaje.',
  ),
  bookingPaymentSuccessTitle: LocalizedText(
    nl: 'Boeking aangemaakt',
    en: 'Booking created',
    fr: 'Reservation creee',
    es: 'Reserva creada',
  ),
  bookingPaymentRequiredMessage: LocalizedText(
    nl: 'Betaling is vereist voordat de rit bevestigd wordt.',
    en: 'Payment is required before the ride is confirmed.',
    fr: 'Le paiement est requis avant confirmation de la course.',
    es: 'Se requiere pago antes de confirmar el viaje.',
  ),
