...
class NavDiagnosticsRecorder {
  ...
  Future<void> recordValidationReport({
    ...
    required String reason,
    int medianCallbackIntervalMs = 0,
    int p95CallbackIntervalMs = 0,
    int maxSourceAgeMs = 0,
    int maxMarkerLagMs = 0,
    int predictionGapExceededCount = 0,
    int predictionGapExceededMs = 0,
    int cameraStaleTargetDrops = 0,
    String rerouteObservation = 'reroute_not_observed',
  }) async {
    await _appendEvent(
      ...
      data: <String, dynamic>{
        ...
        'maxSourceAgeMs': maxSourceAgeMs,
        'maxMarkerLagMs': maxMarkerLagMs,
        'predictionGapExceededCount': predictionGapExceededCount,
        'predictionGapExceededMs': predictionGapExceededMs,
        'cameraStaleTargetDrops': cameraStaleTargetDrops,
        'rerouteObservation': _sanitizeToken(rerouteObservation),
