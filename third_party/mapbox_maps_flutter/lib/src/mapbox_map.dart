...
class MapboxMap extends ChangeNotifier {
  ...
  /// FLUXIDI Phase 2A local patch — plugin-internal `channelSuffix` exposed
  /// as a stable string so app-local companion plugins can address the
  /// exact map instance via [MapboxMapViewRegistry] on the Kotlin side.
  /// See `third_party/mapbox_maps_flutter/PATCHES.md`.
  String get fluxidiMapInstanceId => _mapboxMapsPlatform.channelSuffix.toString();
