...
import { publishedLimousineIdentityDigest } from "./limousine_published_identity.mjs";
import {
...
export function limousinePublicContentDigest({
  ...
  return JSON.stringify({
    ...
    selected: (Array.isArray(selectedVehicleIds) ? selectedVehicleIds : [])
      .map(String)
      .sort(),
    published_identity: publishedLimousineIdentityDigest(publishedIdentity || hero),
  });
}
